...
<head>
    ...
    <title>CSI - Reset Password</title> <!-- The title tag shows in email notifications, like Android 4.4. -->
    ...
    <center style="width: 100%;">
        ...
        <div style="max-width: 680px;">
            ...
            <table cellspacing="0" cellpadding="0" border="0" align="left" bgcolor="#ffffff" width="100%" style="max-width: 680px;">
                <tr>
                    <td style="padding: 20px 0; text-align: center; font-family: sans-serif; font-size: 22px; mso-height-rule: exactly; line-height: 1.1em; color: #000000;">
                        CSI - Reset Password
                    </td>
                </tr>
            </table>
            <!-- Email Header : END -->
            <div style="width: 50px; margin: 0 auto; height: 1px; background-color: #000000"></div>
            <!-- Email Body : BEGIN -->
