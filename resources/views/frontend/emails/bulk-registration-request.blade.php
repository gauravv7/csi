...
<head>
    ...
    <title>Request for Bulk Payments</title> <!-- The title tag shows in email notifications, like Android 4.4. -->
                        ...
                        <table cellspacing="0" cellpadding="0" border="0" width="90%">
                            <tr>
                                <td style="padding: 40px 20px; text-align: center; font-family: sans-serif; font-size: 14px; mso-height-rule: exactly; line-height: 20px; color: #555555; border-top: 1px solid #9c9c9c; border-bottom: 1px solid #9c9c9c">
                                    Dear {{$name}},
                                    <br><br>
                                    Your Request for Bulk payment at Computer Society of India (CSI), have been received successfully from account associated with <br><br>
                                    Login ID - {{$email}}
                                    <br><br>
