...
<head>
    ...
    <title>Acceptance of Application for CSI Individual Membership!</title> <!-- The title tag shows in email notifications, like Android 4.4. -->
...
<table cellpadding="0" cellspacing="0" border="0" height="100%" width="100%" bgcolor="#F4F4F4" style="border-collapse:collapse;"><tr><td valign="top">
    <center style="width: 100%;">
        ...
        <div style="display:none;font-size:1px;line-height:1px;max-height:0px;max-width:0px;opacity:0;overflow:hidden;mso-hide:all;font-family: sans-serif;">
            Acceptance of Application for CSI Individual Membership!
        </div>
                ...
                <tr>
                    <td>
                        <table cellspacing="0" cellpadding="0" border="0" width="90%">
                            <tr>
                                <td style="padding: 40px 20px 0; text-align: left; font-family: sans-serif; font-size: 14px; mso-height-rule: exactly; line-height: 20px; color: #555555; border-top: 1px solid #9c9c9c; border-bottom: 1px solid #9c9c9c">
                                    Dear {{$name}},
                                    <br><br>
                                ...
                                <td style="padding: 0 20px 40px; text-align: justify; font-family: sans-serif; font-size: 14px; mso-height-rule: exactly; line-height: 20px; color: #555555;">
                                    <table cellspacing="0" cellpadding="0" border="0" width="90%">
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: left">
                                                @if($period==80) Life Membership @else {{ $period }} @endif
                                            </td>
                                        </tr>
                                    </table>
                                    <br/>
                                    ...
                                    <br>
                                    After login, under Members Area, kindly refer and take advantage of the facilities and services available to CSI Members, like downloading your Membership ID Card, Membership Certificate, free access to our publications, submission of proposals, etc.
                                </td>
                            </tr>
                        </table>
                    </td>
