...
<head>
    ...
    <title>CSI Nominee Registration(Renewed)</title> <!-- The title tag shows in email notifications, like Android 4.4. -->
...
<table cellpadding="0" cellspacing="0" border="0" height="100%" width="100%" bgcolor="#F4F4F4" style="border-collapse:collapse;"><tr><td valign="top">
            <center style="width: 100%;">
                ...
                <div style="display:none;font-size:1px;line-height:1px;max-height:0px;max-width:0px;opacity:0;overflow:hidden;mso-hide:all;font-family: sans-serif;">
                    CSI Nominee Registration(Renewed)
                </div>
                                ...
                                <table cellspacing="0" cellpadding="0" border="0" width="90%">
                                    <tr>
                                        <td style="padding: 40px 20px; text-align: center; font-family: sans-serif; font-size: 14px; mso-height-rule: exactly; line-height: 20px; color: #555555; border-top: 1px solid #9c9c9c; border-bottom: 1px solid #9c9c9c">
                                            Dear {{$name}},
                                            <br><br>
                                            Your membership has been renewed as a CSI Nominee bearing primary login Email ID as <strong>{{$email}}</strong> for institution <strong>{{$associating_institution}}</strong> effective from <strong>{{$date}}</strong>.
                                        </td>
                                    </tr>
                                </table>
                            </td>
