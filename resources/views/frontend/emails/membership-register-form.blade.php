...
<table cellpadding="0" cellspacing="0" border="0" height="100%" width="100%" bgcolor="#F4F4F4" style="border-collapse:collapse;"><tr><td valign="top">
    <center style="width: 100%;">
        ...
        <div style="display:none;font-size:1px;line-height:1px;max-height:0px;max-width:0px;opacity:0;overflow:hidden;mso-hide:all;font-family: sans-serif;">
            Submission of Application for CSI Membership!
        </div>
                ...
                <tr>
                    <td>
                        <table cellspacing="0" cellpadding="0" border="0" width="90%">
                            <tr>
                                <td style="padding: 40px 20px; text-align: justify; font-family: sans-serif; font-size: 14px; mso-height-rule: exactly; line-height: 20px; color: #555555; border-top: 1px solid #9c9c9c; border-bottom: 1px solid #9c9c9c">
                                    Dear {{$name}},
                                    <br><br>
                                    Your application for Computer Society of India (CSI) membership for category <strong>{{$category}}</strong>, has been received successfully.
                                    <br><br>
                                    ...
                                    <br/>
                                    Please Login to <a href="http://www.csi-india.org">http://www.csi-india.org</a> and do your payments for the same applied service.
			                        <br>
			                        Security Advice: Do change your password after logging in.
                                </td>
                            </tr>
                        </table>
                    </td>
