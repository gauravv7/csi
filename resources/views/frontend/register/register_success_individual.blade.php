...
@section('main')
	<section id="main">
   		<div class="container">
   			<div class="row">
   				<div class="col-md-12">
   					@if($isPayableBalanced)
					  <h3 class="section-header-style">Successful submission of Application for CSI Individual membership!</h3>
					@else
					  <h3 class="section-header-style">Your Payments are not complete!</h3>
					@endif
					  <div class="row">
						  <div class="col-md-12" style="border-left: 2px solid #3f5586;">
							...
							<p>Your application for <strong>Individual Membership</strong> of <strong>Computer Society of India (CSI)</strong> has been received successfully.</p>
							<p>
