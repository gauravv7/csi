...
class AddressController extends Controller
{
    ...
    public function create($id)
    {
        ...
        if($address_types->isEmpty()){
            ...
            return view('backend.memberships.address-create', compact('address_types', 'username', 'countries', 'states', 'id'));
        }
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend.memberships.address-edit', compact('address', 'username', 'entity', 'isSingleStep', 'countries', 'states', 'chapters', 'stud_branch'));
